        ...
        <div class="row justify-content-center">
          <div class="ml-5">
            <div class="text-light mt-5">
              ...
              <a class="text-light" href="http://localhost:3000/edit-pages"
                >FAQ</a
              >
              /
              <a class="text-light" href="" onclick="return false;">Add FAQ</a>
            </div>
            ...
            <div class="overflow-hidden mb-5">
              <div class="row">
                <div class="col-lg-8">
                  <div class="card-body">
                    <h3>Add FAQ</h3>
                    <p>Please provide the FAQ that you want to add below.</p>
                    <div class="container">
                      <form class="text-start" @submit.prevent="storeFaq(form)">
                        <div class="row">
                          <div class="col">
                            <div class="mb-2">
