...
const { faq, getFaq, updateFaq, errors } = useFaqs();
        ...
        <div class="row justify-content-center">
          <div class="ml-5">
            <div class="text-light mt-5">
              ...
              <a class="text-light" href="http://localhost:3000/emails"
                >Email</a
              >
              /
              ...
              <div class="row">
                <div class="col-lg-8">
                  <div class="card-body">
                    <h3>Edit FAQ</h3>
                    <p>
                      Please Fill the FAQ information that you want to update
                      below.
                    </p>
                    <div class="container">
                      <form
                        class="text-start"
                        @submit.prevent="updateFaq($route.params.id)"
                      >
                        <div class="row">
                          <div class="col">
                            <div class="mb-2">
