          ...
          <div class="col">
            <div class="overflow-hidden mb-5">
              <div class="row">
                <div class="col-lg-8">
                  <div class="card-body">
                    <h3>Add Featured Topic</h3>
                    <p>
                      Please provide the Featured Topic that you want to add
                      below.
                    </p>
                    <div class="container">
                      <form
                        class="text-start"
                        @submit.prevent="storeFeaturedTopic(form)"
                      >
                        <div class="row">
                          <div class="col">
                            <div class="mb-2">
                            ...
                            <div class="mb-2">
                              <label class="text-dark pr-3" for="Email"
                                >Upload File</label
                              >
                              <input
                                type="file"
...
export default {
  ...
  methods: {
    handleFileChange(event) {
      this.form.file_data = event.target.files[0];
      console.log(this.form.file_data);
    },
    async storeFeaturedTopic() {
      try {
        const formData = new FormData();
        formData.append("title", this.form.title);
        formData.append("description", this.form.description);
        formData.append("file_data", this.form.file_data);
        await axios.post("/api/featured_topic", formData);
