      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="ml-5">
            ...
            <h1 class="text-white mt-4">Contact Information</h1>
          </div>
        </div>
      </div>
    </div>
...
export default {
  ...
  mounted() {
    ...
    this.getEmailData(this.$route.params.id);
  },
  methods: {
    getEmailData(EmailId) {
      axios
        .get(`http://127.0.0.1:8000/api/emails/${EmailId}/edit`)
        .then((res) => {
    ...
    updateEmail() {
      ...
      axios
        .put(
          `http://127.0.0.1:8000/api/emails/${this.EmailId}/edit`,
          this.model.email
        )
        .then((res) => {
