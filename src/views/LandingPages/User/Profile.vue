...
const { Profile, getupdateProfile, updateProfile, errors } = useUsers();

onMounted(() => getupdateProfile());
</script>
          ...
          <div class="row">
            <div class="col-md-2 mx-auto mt-md-0 d-flex align-items-center">
              <div class="position-sticky" style="top: 100px !important">
                <h3 class="mt-4 mr-4">Edit Profile</h3>
              </div>
            </div>
            <div class="col-md-10">
              <div class="row">
                    ...
                    <div class="row">
                      <div class="col-lg-8">
                        <div class="card-body">
                          <div class="container">
                            <h6>
                              Please provide fill the profile information that
                              you want to edit.
                            </h6>
                            <form
                              class="text-start"
