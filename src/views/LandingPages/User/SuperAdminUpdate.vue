...
const { SuperAdmin, getSuperAdmin, updateSuperAdmin, errors } = useUsers();
...
onMounted(() => getSuperAdmin(props.id));
</script>
          ...
          <div class="row">
            <div class="col-md-2 mx-auto mt-md-0 d-flex align-items-center">
              <div class="position-sticky" style="top: 100px !important">
                <h3 class="mt-4 mr-4">Edit Support Person</h3>
              </div>
            </div>
            <div class="col-md-10">
              <div class="row">
                    ...
                    <div class="row">
                      <div class="col-lg-8">
                        <div class="card-body">
                          <div class="container">
                            <h6>
                              Please provide the Support user details that you
                              want to edit below.
                            </h6>
                            <form
                              class="text-start"
                              @submit.prevent="
                                updateSuperAdmin($route.params.id)
                              "
                            >
                              <div class="row">
                                <div class="col">
