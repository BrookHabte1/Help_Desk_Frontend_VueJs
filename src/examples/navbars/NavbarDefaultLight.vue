        ...
        <ul class="navbar-nav navbar-nav-hover ms-auto">
          <li class="nav-item list-group-item mx-2">
            ...
            >
              ...
              >
                <span class="font-weight-bolder text-dark">Help</span>
              </RouterLink>
            </a>
          </li>
          <li class="nav-item list-group-item mx-2">
            ...
            >
              <RouterLink
                ...
                :to="{ name: 'faq' }"
              >
                <span class="font-weight-bolder text-dark">FAQs</span>
              </RouterLink>
            </a>
          </li>
          <li
          ...
          >
            ...
            >
              <RouterLink
                ...
                :to="{ name: 'contact' }"
              >
                <span class="font-weight-bolder text-dark">Contact</span>
              </RouterLink>
            </a>
          </li>
          <li
            class="nav-item list-group-item"
            v-if="authStore.user.data.role != 'contact_user'"
          >
            <a
              role="button"
              class="nav-link ps-2 d-flex cursor-pointer align-items-center"
            ...
            >
              <RouterLink
                ...
                :to="{ name: 'manage' }"
              >
                <span class="font-weight-bolder text-dark">Manage</span>
              </RouterLink>
            </a>
          </li>
          <li class="nav-item dropdown dropdown-hover">
            <a
              role="button"
              class="nav-link text-bold ps-2 d-flex cursor-pointer align-items-center"
              :class="getTextColor()"
              id="dropdownMenuDocs"
              data-bs-toggle="dropdown"
              aria-expanded="false"
            >
              Hi, {{ authStore.authUser.data.name }}
              <img
                :src="getArrowColor()"
                alt="down-arrow"
...
svg:hover path {
  fill: #434242; /* Change the fill color when hovered */
}
</style>
